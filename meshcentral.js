...
function CreateMeshCentralServer(config, args) {
    ...
    obj.Start = function () {
        ...
        if ((obj.platform == 'win32') && (obj.service != null)) {
            ...
            if (((obj.args.xinstall == true) || (obj.args.xuninstall == true) || (obj.args.start == true) || (obj.args.stop == true) || (obj.args.restart == true))) {
                ...
                const svc = new obj.service({ name: 'Remote Control', description: 'MeshCentral Remote Management Server', script: servicepath, env: env, wait: 2, grow: 0.5 });
    ...
    obj.meshAgentsArchitectureNumbers = {
        ...
        3: { id: 3, localname: 'RemoteAgent.exe', rname: 'remoteagent32.exe', desc: 'Windows x86-32 service', update: true, amt: true, platform: 'win32', core: 'windows-amt', rcore: 'windows-recovery', arcore: 'windows-agentrecovery', tcore: 'windows-tiny', codesign: true },
        4: { id: 4, localname: 'RemoteAgent64.exe', rname: 'remoteagent64.exe', desc: 'Windows x86-64 service', update: true, amt: true, platform: 'win32', core: 'windows-amt', rcore: 'windows-recovery', arcore: 'windows-agentrecovery', tcore: 'windows-tiny', codesign: true },
...
function mainStart() {
    ...
    InstallModules(['minimist'], function () {
        ...
        var modules = ['ws@5.2.3', 'cbor@5.2.0', '@yetzt/nedb', 'https', 'yauzl', 'ipcheck', 'express', 'archiver@5.3.1', 'multiparty', 'node-forge', 'express-ws@4.0.0', 'compression', 'body-parser', 'cookie-session@2.0.0', 'express-handlebars'];
